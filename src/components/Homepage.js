...
const Homepage = () => {
    ...
    const fullText = 'Ola, Seja bem-vindo(a) ao meu portfolio, primeiramente, obrigado pela visita! Aqui voce tem ' +
        'acesso aos projetos (Pessoais, Profissionais e Academicos) que eu faco parte alem de poder visualizar os meus ' +
        'repositorios onde mantenho o codigo fonte dos meus projetos, e por fim, voce tambem pode entrar em contato comigo ' +
        'atraves da barra de navegacao.';
    ...
    return (<>
        ...
        <Link to={"/projects"}>
            <button className={styles.butao}>Quero Conhecer</button>
        </Link>
    </>);
};
